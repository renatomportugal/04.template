function init() {
  ...
  // read in the predefined graph using the JSON format data held in the "diagramModel" textarea
  load();
}
...
function save() {
  document.getElementById("diagramModel").value = myDiagram.model.toJson();
  myDiagram.isModified = false;
}
function load() {
  myDiagram.model = go.Model.fromJson(
    document.getElementById("diagramModel").value
  );
}
...
function prettyPrint() {
  //https://stackoverflow.com/questions/26320525/prettify-json-data-in-textarea-input
    var ugly = document.getElementById('diagramModel').value;
    var obj = JSON.parse(ugly);
    var pretty = JSON.stringify(obj, undefined, 4);
    document.getElementById('diagramModel').value = pretty;
}