function init() {
    ...
    myDiagram.nodeTemplateMap.add("",  // the default category
      $(go.Node, "Spot", nodeStyle(),
        ...
        $(go.Panel, "Auto",
          $(go.Shape, "Rectangle",
            { name: "SHAPE", fill: "#00A9C9", stroke: null },
            new go.Binding("fill"), // ADDED        
            new go.Binding("figure")),
          $(go.TextBlock,
            {
 //             font: "bold 11pt Helvetica, Arial, sans-serif",
              name: "TEXTBLOCK",  // ADDED
              stroke: lightText,
              margin: 8,
 ...
 //             editable: true
            ...
            new go.Binding("font"), //ADDED               
            new go.Binding("editable", "edit"), // ADDED
            new go.Binding("stroke")) // ADDED
        ),
...
function showPalette() {
  document.getElementById("myPaletteDiv").style.visibility = "visible";
}

function hidePalette() {
  document.getElementById("myPaletteDiv").style.visibility = "hidden";
}


// Node adornment buttons
